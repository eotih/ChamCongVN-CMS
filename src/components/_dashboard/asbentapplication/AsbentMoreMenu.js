  ...
  return (
    <>
      ...
      >
        <MenuItem
          onClick={() => {
            if (confirm('Are you sure you want to delete this Asbent Application?')) {
              axios.delete(`Application/AbsentApplication/${AbsentApplicationID}`).then((res) => {
        ...
        <MenuItem
          onClick={() => {
            if (confirm('Are you sure you want to approve this Asbent Application?')) {
              axios
        ...
        <MenuItem
          onClick={() => {
            if (confirm('Are you sure you do not want to approve this Asbent Application?')) {
              axios
                .put(`Application/AbsentApplication/EditState/${AbsentApplicationID}`, {
                  AbsentApplicationID,
                  StateID: 3,
